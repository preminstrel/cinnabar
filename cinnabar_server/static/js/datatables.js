 ...
 *   https://datatables.net/download/#bs5/dt-1.13.4/fc-4.2.2/fh-3.3.2/r-2.4.1/sp-2.1.2/sl-1.6.2
 *
 * Included libraries:
 *   DataTables 1.13.4, FixedColumns 4.2.2, FixedHeader 3.3.2, Responsive 2.4.1, SearchPanes 2.1.2, Select 1.6.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.4/fc-4.2.2/fh-3.3.2/r-2.4.1/sp-2.1.2/sl-1.6.2",
